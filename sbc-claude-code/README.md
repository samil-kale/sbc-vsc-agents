...
- **Session tabs** — run multiple Claude Code sessions side by side in a VS Code-style tab strip: your existing sessions show up as tabs with their titles, the **+** button starts a fresh one, double-clicking a tab lets you rename it, and closing a tab deletes its session.
